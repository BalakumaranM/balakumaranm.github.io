...
<div style="display: flex; justify-content: space-between;">
  <div style="width:45%;">
    ...
    <p><strong>Signal measured in the free-vibration of the structure using the ADXL-335 accelerometer (Time History)</strong></p>
    <p>[View Original Image](https://minio.scielo.br/documentstore/1806-9126/8qmZXrrGQCgvkvSRjJRXjXh/68593e3192fd6a31c82e83b10ec670b05589f88b.jpg)</p>
  </div>
  <div style="width:45%;">
    <img src="/images/blog_related/natural_acceleration.png" alt="Right Graph" style="width:100%;">
    <p><strong>Signal measured when the structure is excited by a frequency of 13.12 Hz using the ADXL-335 accelerometer (Time History)</strong></p>
    <p>[View Original Image](https://minio.scielo.br/documentstore/1806-9126/8qmZXrrGQCgvkvSRjJRXjXh/fe9e289380fda74234631b8d34e9babbc035b927.jpg)</p>
  </div>
</div>
